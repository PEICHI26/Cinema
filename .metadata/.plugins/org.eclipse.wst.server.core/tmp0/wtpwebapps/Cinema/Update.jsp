...
<body>
	<div class="container">
		...
		<form action="MovieServlet" method="post">
			<div class="row">
				<div class="col-25">
					<label for="movieno">Movie Number</label>
				</div>
				<div class="col-75">
					<input type="text" id="movieno" name="movieno" placeholder="">
				</div>
			</div>
			<div class="row">
				<div class="col-25">
		...
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATELENGTH" value="修改">
			</div>
		</form>
		<h3>修改電影上映日期</h3>
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATEDATE" value="修改">
			</div>
		</form>
		<h3>修改電影類別</h3>
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATETYPE" value="修改">
			</div>
		</form>
		<h3>修改電影導演</h3>
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATEDIRECTOR" value="修改">
			</div>
		</form>
		<h3>修改電影演員</h3>
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATEACTOR" value="修改">
			</div>
		</form>
		<h3>修改電影分級</h3>
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATEGRADING" value="修改">
			</div>
		</form>
		<h3>修改電影上映狀態</h3>
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATERELEASE" value="修改">
			</div>
		</form>
		<h3>修改電影簡介</h3>
		<form action="MovieServlet" method="post">
			...
			<br>
			<div class="row">
				<input type="submit" name="UPDATEINTRO" value="修改">
			</div>
		</form>
	</div>
